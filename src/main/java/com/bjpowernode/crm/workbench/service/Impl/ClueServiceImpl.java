...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        //--------------------------------------------------------------
        //经过第三步处理后，联系人的信息我们已经拥有了，将来在处理其他表的时候，如果要使用到客户的id
        //直接使用con.getId();
        //--------------------------------------------------------------
        //添加联系人
        ...
        //查询出于该线索关联的备注信息列表
        List<ClueRemark> clueRemarkList = customerRemarkDao.getListByClueId(clueId);
        ...
        //查询出于该条线索关联的市场活动，查询与市场活动关联的关系列表
